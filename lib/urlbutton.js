...
function markOpened(browserWindow) {
	...
	let button = document.getElementById('fr_hardcoding_scrollupfolder_urlbar_button');
	// Mark the button as open
	button.setAttribute('open', 'true');
}

/**
 * Mark the URL button as closed.
 * @param	browserWindow	The browser window to mark the URL button as closed.
 */
...
function initialize(browserWindow) {
	...
	let urlbar_icons = document.getElementById('urlbar-icons');
